...
public class SpringFrameworkOrmResolutionTest extends AbstractSpringBundleResolutionTest {
    ...
    public static Option[] configuration() throws Exception {
        return options(//
            ...
            provisionMirroredGradleBundle("org.springframework.jdbc"), //
            provisionMirroredGradleBundle("org.springframework.orm"), //
    ...
    public void springBundleShouldBeActive() throws Exception {
        assertSpringBundleIsActive("org.springframework.orm");
    }
}